...
QBCore.Commands.Add("fix", "Repair your vehicle (Admin Only)", {}, false, function(source, args) TriggerClientEvent('jim-mechanic:client:fixEverything', source) end, "admin")
