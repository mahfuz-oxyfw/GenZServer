-- Changes the time
RegisterNetEvent('oxa-adminmenu:client:ChangeTime', function(data, selectedData)
...
-- Changes the weather
RegisterNetEvent('oxa-adminmenu:client:ChangeWeather', function(data, selectedData)
    local data = CheckDataFromKey(data)
    if not data or not CheckPerms(data.perms) then return end
...
RegisterNetEvent('oxa-adminmenu:client:copyToClipboard', function(data, selectedData)
    local data = CheckDataFromKey(data)
    if not data or not CheckPerms(data.perms) then return end
