...
Integrated with [ds-mdt](https://github.com/Project-Sloth/ds-mdt)
...
3. [ds-mdt](https://github.com/Project-Sloth/ds-mdt) - Optional but highly recommended.
...
* There are no calls showing on dispatch or mdt list.
  ...
  - On shared/config.lua make set Config.Debug = true to test calls as leo officer.(ONLY to be used as testing, make sure to disable on live production)
