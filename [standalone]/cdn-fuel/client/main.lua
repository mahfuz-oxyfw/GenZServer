    ...
    while true do
        ...
        if pumpGrabbed then
            ...
            if veh and not IsVehicleBlacklisted(veh) then
                ...
                if (vehClass == 8 or vehClass == 9 or vehClass == nil) and vehClass ~= 13 then
                ...
                elseif vehClass ~= 13 then
                    ...
                    -- Optional: Add special case for vehClass 13
                    tankBone = GetEntityBoneIndexByName(veh, "petrolcap")
                    if tankBone == -1 then
                        tankBone = GetEntityBoneIndexByName(veh, "petroltank")
                    end
				...
				local ped = PlayerPedId()
				local pedCoords = GetEntityCoords(ped)
                if tankPosition and #(pedCoords - tankPosition) < 1.5 then
                    if not nozzleInVehicle and pumpGrabbed then
                        nearTank = true
