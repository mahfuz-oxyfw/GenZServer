...
CreateThread(function()
    uwuCafe = AddBlipForCoord(179.76, -233.09, 54.05)
    SetBlipSprite (uwuCafe, 489)
    SetBlipDisplay(uwuCafe, 4)
    SetBlipScale  (uwuCafe, 0.8)
    SetBlipAsShortRange(uwuCafe, true)
    SetBlipColour(uwuCafe, 1)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("CHILL Cafe")
...
function uwuZones()
	...
	exports['qb-target']:AddTargetEntity(jobPed, { 
		...
		{ 
		    type = "client",
		    event = "GZ-chillcafe:client:jobGarage",
		...
		{ 
		    type = "client",
		    event = "GZ-chillcafe:client:storeGarage",
		    icon = "fa-solid fa-clipboard-check",
		    label = "Store Vehicle",
		    job = "uwu"
		},
...
RegisterNetEvent('GZ-chillcafe:client:jobGarage', function(vehicle)
...
RegisterNetEvent('GZ-chillcafe:client:storeGarage', function()
...
RegisterNetEvent("GZ-chillcafe:client:stash1", function()
...
RegisterNetEvent("GZ-chillcafe:client:stash2", function()
...
RegisterNetEvent("GZ-chillcafe:client:stash3", function()
...
RegisterNetEvent("GZ-chillcafe:client:stash4", function()
...
RegisterNetEvent("GZ-chillcafe:client:stash5", function()
...
RegisterNetEvent("GZ-chillcafe:client:stash6", function()
...
RegisterNetEvent("GZ-chillcafe:client:stash7", function()
...
RegisterNetEvent("GZ-chillcafe:client:stash8", function()
...
RegisterNetEvent("GZ-chillcafe:client:stash9", function()
...
RegisterNetEvent("GZ-chillcafe:client:stash10", function()
...
RegisterNetEvent("GZ-chillcafe:client:tray1", function()
...
RegisterNetEvent("GZ-chillcafe:client:tray2", function()
...
RegisterNetEvent("GZ-chillcafe:client:tray3", function()
...
RegisterNetEvent("GZ-chillcafe:client:refregiator", function()
...
RegisterNetEvent("GZ-chillcafe:client:openShop", function()
    TriggerServerEvent("inventory:server:OpenInventory", "shop", "uwuShop", Config.Items)
end)

RegisterNetEvent('GZ-chillcafe:clientToggleDuty', function()
    TriggerServerEvent("QBCore:ToggleDuty")
end)

--[[ RegisterNetEvent("GZ-chillcafe:bill", function()
    ...
    if bill ~= nil then
        ...
        TriggerServerEvent("GZ-chillcafe:server:billPlayer", bill.citizenid, bill.billprice)
    end
end)
 ]]