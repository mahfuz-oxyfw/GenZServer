...
AddEventHandler("playerDropped", function(reason)
    ...
    TriggerClientEvent("gz-scoreboard:client:UpdateConnect", -1, connectedPlayers)
	TriggerClientEvent("gz-scoreboard:client:combat", -1, source, GetEntityCoords(GetPlayerPed(source)), recentPlayers[plyid].license, reason)
    TriggerClientEvent("gz-scoreboard:client:UpdateRecent", -1, recentPlayers)
    Wait(600000)
    recentPlayers[plyid] = nil
    TriggerClientEvent("gz-scoreboard:client:UpdateRecent", -1, recentPlayers)
end)

RegisterNetEvent('gz-scoreboard:server:AddPlayer', function()
    if not verified then return end
    local src = source
