...
#### Renewed yseries:
- Go to `yseries > server > invoices.lua`
- Search for the event: `yseries:server:PayMyInvoice` and search for this line:
```lua
TriggerEvent("yseries:server:InvoiceHandler", true, amount, src, resource)
```
