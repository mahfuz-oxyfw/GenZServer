...
RegisterCommand('useprinter', function()
    ...
    local PrinterObject = GetClosestObjectOfType(pos.x, pos.y, pos.z, 1.5, `v_ret_gc_print`, false, false, false)
...
if Config.UseTarget then
    CreateThread(function()
        exports['qb-target']:AddTargetModel("v_ret_gc_print", {
            options = {
                {
