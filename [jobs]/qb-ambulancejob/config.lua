...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
        [1] = vector3(-488.31, -988.95, 24.29), -- main
        [2] = vector3(-251.62, 6334.09, 32.43), -- paleto
    },
    ["duty"] = {
        [1] = vector3(-488.24, -985.1, 24.29),
    ...
    ["armory"] = {
        [1] = vector3(-482.91, -1012.16, 24.29),
    ...
    ["stash"] = {
        [1] = vector3(-450.74, -1037.4, 33.69),
    },
    ["beds"] = {
        [1] = {coords = vector4(-458.82, -1023.89, 34.10, 181.03), taken = false, model = 1631638868},
        [2] = {coords = vector4(-454.95, -1023.82, 34.10, 181.64), taken = false, model = 1631638868},
        [3] = {coords = vector4(-451.15, -1023.86, 34.10, 176.41), taken = false, model = 1631638868},
        [4] = {coords = vector4(-447.34, -1024.05, 34.10, 179.14), taken = false, model = 1631638868},
        [5] = {coords = vector4(-447.27, -1030.23, 34.10, 1.18),   taken = false, model = 1631638868},
        [6] = {coords = vector4(-451.18, -1030.39, 34.10, 358.51), taken = false, model = 1631638868},
        [7] = {coords = vector4(-454.99, -1030.50, 34.10, 357.86), taken = false, model = 1631638868},
        [8] = {coords = vector4(-458.65, -1030.20, 34.10, 359.33), taken = false, model = 1631638868},
        [9] = {coords = vector4(-480.26, -1030.18, 25.00, 86.18), taken = false, model = 1631638868},

    --- paleto
        [9] = {coords = vector4(-257.63, 6321.8, 33.15, 314.1), taken = false, model = 2117668672},
        [10] = {coords = vector4(-260.02, 6324.21, 33.15, 309.0), taken = false, model = 2117668672},
        [11] = {coords = vector4(-262.35, 6326.42, 33.15, 315.05), taken = false, model = 2117668672},
    },
    -- ["jailbeds"] = {
    ...
    -- },
    ["stations"] = {
        [1] = {label = Lang:t('info.pb_hospital'), coords = vector4(-495.15, -996.64, 24.29, 345.20)},
        -- [2] = {label = Lang:t('info.pb_hospital'), coords = vector4(-256.1, 6316.89, 32.43, 268.27)},
    }
}
