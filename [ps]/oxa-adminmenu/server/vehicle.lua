-- Admin Car
RegisterNetEvent('oxa-adminmenu:server:SaveCar', function(mods, vehicle, _, plate)
    local src = source
...
-- Give Car
RegisterNetEvent("oxa-adminmenu:server:givecar", function(data, selectedData)
    local src = source
    ...
    local vehicleData = lib.callback.await("oxa-adminmenu:client:getvehData", src, vehmodel)
...
-- Give Car
RegisterNetEvent("oxa-adminmenu:server:SetVehicleState", function(data, selectedData)
    local src = source
...
-- Change Plate
RegisterNetEvent('oxa-adminmenu:server:ChangePlate', function(newPlate, currentPlate)
...
lib.callback.register('oxa-adminmenu:server:GetVehicleByPlate', function(source, plate)
...
RegisterNetEvent('oxa-adminmenu:server:FixVehFor', function(data, selectedData)
    local data = CheckDataFromKey(data)
