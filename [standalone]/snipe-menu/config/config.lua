...
Config.CommandName = "qaz" -- command to open the menu
...
Config.Discord = "https://discord.gg/VTxNeGRRQN" -- discord link to show when you ban a player in the ban message

Config.ShowInGameNames = false -- to show the in game names of the players in player list (if your server lags a lot, please set this to false)
