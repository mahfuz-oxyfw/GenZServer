...
---@param xPlayer Player Player Data
---@param itemName string item name
---@param metadata? table|string metadata
---@param strict? boolean strict
---@return number itemCount
function Utils.CustomInventory:GetItemCount(xPlayer, itemName, metadata, strict)
    -- local source = xPlayer.source
    -- local itemCount = exports.["CustomInventory"]:GetItemCount(source, itemName, metadata, strict)
    -- return itemCount
end

function Utils.CustomInventory:GetItem(xPlayer, itemName, metadata, returnsCount)
    -- local source = xPlayer.source
    -- local item = exports.["CustomInventory"]:GetItem(source, itemName, metadata, returnsCount)
    -- return item
end

function Utils.CustomInventory:SetItemMetaData(xPlayer, slot, metaData)
    -- local source = xPlayer.source
    -- return exports.["CustomInventory"]:SetItemMetaData(source, slot, metaData)
end

function Utils.CustomInventory:RemoveItem(xPlayer, itemName, count, metadata, slot)
    -- local source = xPlayer.source
    -- return exports.["CustomInventory"]:RemoveItem(source, itemName, count, metadata, slot)
end

function Utils.CustomInventory:AddItem(xPlayer, itemName, count, metadata, slot)
    -- local source = xPlayer.source
    -- return exports.["CustomInventory"]:AddItem(source, itemName, count, metadata, slot)
end

function Utils.CustomInventory:SetItemDurability(xPlayer, slot, durability, itemName)
    -- local source = xPlayer.source
