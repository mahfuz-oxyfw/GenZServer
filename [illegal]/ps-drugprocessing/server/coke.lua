...
RegisterServerEvent('ps-drugprocessing:processCocaBrick', function()
	...
	if Player.Functions.RemoveItem('coke_small_brick', Config.CokeProcessing.SmallBrick) then
		if Player.Functions.AddItem('coke_toy', Config.CokeProcessing.CokeToy) then
			...
			TriggerClientEvent("inventory:client:ItemBox", src, QBCore.Shared.Items['coke_toy'], "add", Config.CokeProcessing.CokeToy)
			TriggerClientEvent('QBCore:Notify', src, Lang:t("success.coke_toy"), "success")
		else
