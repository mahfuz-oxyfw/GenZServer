...
--[[         vector3(1992.803, 3047.312, 46.22865),
    ...
    Text = {
        ...
        HINT_SETUP = 'Set up game',
        HINT_TAKE_CUE = 'Take the cue.',
        HINT_RETURN_CUE = 'Return the cue.',
        HINT_HINT_TAKE_CUE = 'You need to take a cue to play pool.',
        HINT_PLAY = 'Play',
        ...
        BALL_POCKETED = 'You pocketed the %s ball',
        BALL_IN_HAND_NOTIFY = 'You have taken the billiard ball in hand',    
        BALL_LABELS = {
            [-1] = 'Cue',
            [1] = '~y~Solid 1~s~',
            [2] = '~b~Solid 2~s~',
