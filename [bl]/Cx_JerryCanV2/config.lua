...
Config.FillAmount = 100 -- Fill amount from 0 to 100 | This will add the amount to the current vehicle gas amount

--JerryCan props
Config.BackProps = false -- If you don't want on back prop make it false
