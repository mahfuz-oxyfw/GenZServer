	...
	const debugActions = [
		...
		},
		{
			...
			dropdown: [
				...
				{ label: "Ban", type: "server", option: "button", event: "oxa-adminmenu:client:banplayer" },
			],
		},
		{
			id: "noclip",
			...
			type: "client",
			perms: "mod",
			event: "oxa-adminmenu:client:noclip",
		},
		{
			id: "invisible",
			label: "Invisible",
			type: "client",
			perms: "mod",
			event: "oxa-adminmenu:client:invisible",
		},
		{
			id: "kick_player",
			label: "Kick Player",
			type: "client",
			perms: "mod",
			event: "oxa-adminmenu:client:kickplayer",
			dropdown: [
				{ label: "Player", option: "dropdown", data: "players" },
				{ label: "Reason", option: "text" },
				{ label: "Time", option: "dropdown", 
