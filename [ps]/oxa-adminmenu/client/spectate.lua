...
RegisterNetEvent('oxa-adminmenu:requestSpectate', function(targetPed, target, name)
...
RegisterNetEvent('oxa-adminmenu:cancelSpectate', function()
    ...
    while true do
        ...
        if spectateInfo['toggled'] then
            ...
            if DoesEntityExist(targetPed) then
                ...
                TriggerServerEvent('oxa-adminmenu:spectate:teleport', spectateInfo['target'])
