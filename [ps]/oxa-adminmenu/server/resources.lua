...
lib.callback.register('oxa-adminmenu:callback:GetResources', function(source)
...
lib.callback.register('oxa-adminmenu:callback:ChangeResourceState', function(source, data, perms)
