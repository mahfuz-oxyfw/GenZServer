...
RegisterNetEvent('Dutyblips:addPolice')
AddEventHandler('Dutyblips:addPolice', function(src)
    local src = src
    print(src)
    addPolice(src)
end)

RegisterNetEvent('Dutyblips:removePolice')
AddEventHandler('Dutyblips:removePolice', function(src)
    local src = src
    print(src)
    removePolice(src)
end)
