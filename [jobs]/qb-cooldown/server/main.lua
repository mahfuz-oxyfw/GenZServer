...
QBCore.Functions.CreateCallback("qb-cooldown:server:getconfig", function(source, cb)
    cb(Config)
end)

RegisterNetEvent("qb-cooldown:server:setprio", function(ptype)
    ...
    TriggerClientEvent("qb-cooldown:client:updateconfig", -1, Config)
end)
