local function getMessagesCallBack()
	return lib.callback.await('oxa-adminmenu:callback:GetMessages', false)
end
...
RegisterNUICallback("SendMessage", function(msgData, cb)
	...
	TriggerServerEvent("oxa-adminmenu:server:sendMessageServer", message, PlayerData.citizenid, PlayerData.charinfo.firstname .. " " .. PlayerData.charinfo.lastname)
