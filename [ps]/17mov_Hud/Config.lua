...
Config.StressingSpeed = 210          -- Speed above which you start to get stressed
...
Config.DefaultSettings = {
    ...
    ['Time'] = "real",       -- Values: ['server', 'real']. Should display server time or real time?
    ...
    ['location'] = false,       -- Values: [true, false, 'inCar']. Show location component
    ['radio'] = false,          -- Values: [true, false]. Show radio component
    ['time'] = false,           -- Values: [true, false]. Show time component
    ['cash'] = false,           -- Values: [true, false]. Show cash component
    ...
    ['bank'] = false,           -- Values: [true, false]. Show bank component
    ['weapon'] = true,         -- Values: [true, false]. Show weapon component
    ['serverId'] = false,       -- Values: [true, false]. Show server id component
    ['job'] = false,            -- Values: [true, false]. Show job component
}
...
Config.DefaultPositions = {
    ...
    ["society_money"] = false,
    ["weapon"] = false,
    ["healthAndVest"] = { x = 0.16, y = 0.97 },
    ["food"] = { x = 0.19, y = 0.97 },
    ["voice"] = { x = 0.25, y = 0.97 },
    ["stress"] = { x = 0.22, y = 0.97 },
    ["oxygen"] = { x = 0.28, y = 0.97 },
    ["stamina"] = { x = 0.31, y = 0.97 },
    ["vehicle"] = false,
