...
Config = {
	...
	CashInLocation = vector4(0, 0, 0, 0), -- Default Third Window along in Pacific Bank   	--252.23, 223.11, 106.29, 159.2
	...
	Jobs = {
		...
		['police'] = { MinAmountforTicket = 1000, PayPerTicket = 10, Commission = 0.30, },
		...
		['burgershot'] = { MinAmountforTicket = 50, PayPerTicket = 10 , Commission = 0.80, },
		['chillcafe'] = { MinAmountforTicket = 50, PayPerTicket = 10, Commission = 0.80, },
		...
		['mechanic'] = { MinAmountforTicket = 1000, PayPerTicket = 10, Commission = 0.80, },
    ...
    CustomCashRegisters = {
		...
		["burgershot"] = { -- Player job role restriction
			{ coords = vector4(-1192.85, -896.18, 13.97, 305), length = 0.5, width = 0.5, heading = 305, minZ = 10.37, maxZ = 14.37 } ,  
			{ coords = vector4(-1193.87, -894.68, 13.97, 35), length = 0.5, width = 0.5, heading = 35, minZ = 10.37, maxZ = 14.37 } ,  
			{ coords = vector4(-1194.9, -893.16, 13.97, 35), length = 0.5, width = 0.5, heading = 35, minZ = 10.37, maxZ = 14.37 } ,  

		},
		["chillcafe"] = { -- Player job role restriction
			{ coords = vector4(177.51, -234.68, 54.05, 67), length = 0.5, width = 0.5, heading = 67, minZ = 50.15, maxZ = 54.15 } ,  
			{ coords = vector4(178.4, -235.02, 54.05, 341), length = 0.5, width = 0.5, heading = 341, minZ = 50.15, maxZ = 54.15 } ,  
			
		},
		["mechanic"] = { -- Player job role restriction
			{ coords = vector4(2743.2, 3467.38, 55.60, 155), prop = true, length = 0.5, width = 0.8, heading = 155, minZ = 51.72, maxZ = 55.72 } ,  
			-- { coords = vector4(178.4, -235.02, 54.05, 341), length = 0.5, width = 0.5, heading = 341, minZ = 50.15, maxZ = 54.15 } ,  
		
		},
		["police"] = { -- Player job role restriction
			{ coords = vector4(441.26, -991.63, 30.72, 5.0), prop = true, length = 0.4, width = 0.4, heading = 5, minZ = 26.92, maxZ = 30.92 } ,  
			-- { coords = vector4(178.4, -235.02, 54.05, 341), length = 0.5, width = 0.5, heading = 341, minZ = 50.15, maxZ = 54.15 } ,  
