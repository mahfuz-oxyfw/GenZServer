...
RegisterNetEvent('qb-Tequila:client:Eat', function(itemName)
    ...
    QBCore.Functions.Progressbar("eat_something", Language.Progressbars.Eating..QBCore.Shared.Items[itemName].label.."..", 5000, false, true, {
        ...
        TriggerServerEvent("qb-Tequila:Server:RemoveItem", itemName, 1)
...
RegisterNetEvent('qb-Tequila:client:Drink', function(itemName)
