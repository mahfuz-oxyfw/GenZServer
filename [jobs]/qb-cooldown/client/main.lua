...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
    QBCore.Functions.TriggerCallback("qb-cooldown:server:getconfig", function(newconfig)
        Config = newconfig
    end)
end)

RegisterNetEvent("qb-cooldown:client:updateconfig", function(newconfig)
    Config = newconfig
end)
...
RegisterNUICallback("setprio", function(data)
    ...
    TriggerServerEvent("qb-cooldown:server:setprio", data.ptype)
end)
