...
RegisterNetEvent("QBCore:Client:OnPlayerLoaded", function()
    TriggerServerEvent("gz-scoreboard:server:AddPlayer")
end)
...
RegisterNetEvent("gz-scoreboard:client:UpdateConnect", function(data)
    connectedPlayers = {}
...
RegisterNetEvent("gz-scoreboard:client:UpdateRecent", function(data)
    recentPlayers = {}
    for _, v in pairs(data) do
...
RegisterNetEvent('gz-scoreboard:client:toggle', function()
