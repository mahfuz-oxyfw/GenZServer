...
cfg.Discord_Webhook    = "https://discord.com/api/webhooks/1320532700540567562/CUGeN7n23QGlPfLwbKdTewqZOTih0XCE5NhjsIt3WB4k9rDkv8Fq1KfnUd6W2faXcNXH"
...
cfg.Drug_List 		   = {
	["cokebaggy"] = {average_price = 450},
	["coke_toy"] = {average_price = 500},
	["lsd"] = {average_price = 750},
	["meth"] = {average_price = 700},
	["oxy"] = {average_price = 50},
	["weed"] = {average_price = 65},
	["heroin"] = {average_price = 100}
}
...
cfg.Sales_Skill 	   = {
	InterestInDrugs = 60,					-- In percentage 0-100%
	maxQuantity = 8,
	Threshold = 75,						-- Player must have more Points than this value to use Sale Skill
	Limit = 650,							-- Limit of Sales Skill Points
	Skill = 5,								-- Player will receive this value of Sales Skill Points
	Increase_Chance = 15					-- Player will get extra percentage bonus of this value, if you increases the price by 1.2x you will receive 1.2x points more
}
...
cfg.Wholesale_Settings = {
	...
	minQuantity = 50,
	maxQuantity = 300,
	Respect = 60, 						-- Add when trade is done/Remove when you leave zone
...
function DrugSale()
    local coords = GetEntityCoords(cache.ped) -- Get player's location

    local dispatchData = {
        message = locale('drugsell'), -- Add 'drugsell' to your locale file
        codeName = 'suspicioushandoff', -- Match this in config.lua
        code = '10-13', -- Set the appropriate code
        icon = 'fas fa-tablets', -- Icon for the alert
        priority = 2, -- Priority of the alert (1=low, 2=medium, 3=high)
        coords = coords,
        gender = GetPlayerGender(), -- Function to determine player's gender
        street = GetStreetAndZone(coords), -- Street and zone information
        alertTime = nil, -- Optional: set a specific time for the alert
        jobs = { 'police' } -- Who receives this alert (Law Enforcement Officers)
    }
