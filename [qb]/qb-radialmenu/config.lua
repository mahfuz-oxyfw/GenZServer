        ...
        items = {
            {
                ...
                icon = 'address-book',
                type = 'client',
                event = 'yseries:client:GiveContactDetails',
                shouldClose = true
            }, {
                id = 'togglehotdogsell',
...
Config.JobInteractions = {
    ["police"] = {
        --client:unlockNearestVehicle
        {
            id = 'unlock',
            title = 'Unlock Vehicle',
            icon = 'user-lock',
            type = 'client',
            event = 'client:unlockNearestVehicle',
            shouldClose = true
        },
        {
            id = 'putonbed',
