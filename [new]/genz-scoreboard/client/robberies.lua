...
RegisterNetEvent('gz-scoreboard:client:openrobbery', function()
...
RegisterNetEvent('gz-scoreboard:client:toggleRobbery', function()
...
RegisterNetEvent('mm_robbery:client:sync1', function(data, data1)
    ...
    TriggerEvent('gz-scoreboard:client:openrobbery')
end)