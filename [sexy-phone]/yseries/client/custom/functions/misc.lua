...
RegisterNetEvent("yseries:client:CustomNotification", function(title, text, _, _, timeout)
    TriggerServerEvent('yseries:server:yseries-bridge:send-notification', title, text, timeout, GetPlayerServerId(PlayerId()))
end)
