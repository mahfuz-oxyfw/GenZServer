...
Config.StoreParkinglotAccuratly = false  -- store the last parking lot in the DB, if set to true, make sure to apply / run patch1.sql, I recommend applying the tracking snippet for qs-smartphone from the ReadMe to the phone so you can track the vehicle to the exact parking lot
...
Config.Garages = {
    ...
    ['pillboxlowergarage'] = {
        ['Zone'] = {
            ['Shape'] = {
                vector2(-444.63223266602, -948.97857666016),
                vector2(-443.78121948242, -957.82000732422),
                vector2(-515.82501220703, -957.71868896484),
                vector2(-515.78643798828, -948.9169921875)
            },
            ['minZ'] = 23.548515319824,  -- min height of the parking zone
            ['maxZ'] = 23.567701339722,  -- max height of the parking zone
        },
        label = 'LS Medical Center Parking',
        showBlip = false,
        blipcoords = vector3(-499.07, -953.13, 23.55),
        blipName = 'LS Medical Center Parking',
        blipNumber = 357,
        type = 'public',
        vehicleCategories = {'car', 'motorcycle', 'other'},
        drawText = 'Parking',
        debug = false,
        ['ParkingSpots'] = {
            vector4(-481.63, -953.53, 23.55, 184.15),
            vector4(-486.08, -953.92, 23.55, 181.76),
            vector4(-490.34, -954.36, 23.55, 180.11),
            vector4(-499.0, -953.01, 23.55, 182.73),
            vector4(-503.34, -953.13, 23.55, 180.26),
            vector4(-507.6, -953.24, 23.55, 183.11),
            vector4(-511.69, -953.2, 23.55, 181.31),
        }
    },
    ['mirrorpark'] = {
        ['Zone'] = {
    ...
    ['sapcounsel'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
                vector2(-57.632099151611, 888.84753417969),
                vector2(-69.869125366211, 914.52478027344),
                vector2(-83.286888122559, 907.49420166016),
                vector2(-69.810737609863, 882.77783203125)
            },
            ['minZ'] = 235.50170898438,  -- min height of the parking zone
            ['maxZ'] = 235.9017791748,  -- max height of the parking zone
        },
        label = "VineWood Hill Parking",
        showBlip = false,
        blipcoords = vector3(-71.51, 901.64, 235.60),
        blipName = "Public Parking",
        blipNumber = 357,
        type = 'public',                --public, job, gang, depot
        vehicleCategories = {'car', 'motorcycle', 'other'},
        ...
        ['ParkingSpots'] = {
            vector4(-71.48, 903.35, 235.62, 114.84),
            vector4(-70.64, 900.31, 235.59, 118.10),
            vector4(-69.36, 897.47, 235.56, 118.87),
            vector4(-67.80, 894.76, 235.54, 121.34),
            vector4(-66.49, 891.88, 235.56, 116.17)
        }
    },
    ...
    ['caears24'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
                vector2(846.29431152344, -2107.3962402344),
                vector2(847.54681396484, -2093.5766601562),
                vector2(861.82000732422, -2095.4438476562),
                vector2(860.07427978516, -2108.0141601562)
            },
            ['minZ'] = 30.37201499939,  -- min height of the parking zone
            ['maxZ'] = 31.985130310059,  -- max height of the parking zone
        },
        label = "Mechanic Parking",
        showBlip = false,
        blipcoords = vector3(855.35, -2101.7, 30.54),
        blipName = "Public Parking",
        blipNumber = 357,
        type = 'public',                --public, job, gang, depot
        vehicleCategories = {'car', 'motorcycle', 'other'},
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(850.34, -2105.42, 30.53, 268.56),
            vector4(850.45, -2101.99, 30.52, 260.12),
            vector4(850.87, -2098.31, 30.54, 260.64),
        }
    },
    ['caears242'] = {
        ['Zone'] = {
    ...
    ['airportp'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
                vector2(344.46856689453, -205.53533935547),
                vector2(335.97387695313, -227.69165039063),
                vector2(306.42913818359, -216.28266906738),
                vector2(314.71963500977, -194.50833129883)
            },
            ['minZ'] = 54.221813201904,  -- min height of the parking zone
            ['maxZ'] = 54.226440429688,  -- max height of the parking zone
        },
        label = "Motel Parking",
        showBlip = false,
        blipcoords = vector3(323.81, -210.01, 54.09),
        blipName = "Public Parking",
        blipNumber = 357,
        type = 'public',                --public, job, gang, depot
        vehicleCategories = {'car', 'motorcycle', 'other'},
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(337.65, -207.05, 54.06, 71.18),
            vector4(336.19, -210.33, 54.09, 69.03),
            vector4(335.34, -213.72, 54.09, 70.56),
            vector4(333.52, -216.53, 54.09, 72.12),
            vector4(331.64, -207.00, 54.09, 162.54),
            vector4(323.36, -203.80, 54.09, 161.46),
            vector4(318.84, -199.92, 54.09, 249.57),
            vector4(317.19, -203.11, 54.09, 252.06),
            vector4(316.11, -206.46, 54.09, 252.52),
            vector4(314.77, -209.56, 54.09, 249.34),
        }
    },
    ...
    ['legionsquare'] = {
        ...
        type = 'public',                --public, job, gang, depot
        vehicleCategories = {'car', 'motorcycle', 'other'},
        drawText = 'Main Garage',                 --car, air, sea
        debug = false,
        ['ParkingSpots'] = {
    ...
    ['impoundlot'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(408.88623046875, -1615.3507080078),
            vector2(388.09677124023, -1641.9914550781),
            vector2(410.32974243164, -1660.3489990234),
            vector2(423.42153930664, -1645.1468505859),
            vector2(423.09313964844, -1628.1717529297)
            },
            ['minZ'] = 29.287651062012,  -- min height of the parking zone
            ['maxZ'] = 29.292377471924,  -- max height of the parking zone
            debug = false,
        },
        label = "Impound Lot",
        showBlip = true,
        blipcoords = vector3(407.64, -1640.66, 29.29),
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(396.31, -1644.32, 29.29, 320.14),
            vector4(398.58, -1646.46, 29.29, 318.4),
            vector4(400.88, -1648.69, 29.29, 323.49),
            vector4(403.4, -1650.53, 29.29, 321.1),
            vector4(405.63, -1652.69, 29.29, 318.89),
            vector4(407.98, -1654.69, 29.29, 322.27),
            vector4(410.57, -1656.86, 29.29, 322.48),
            vector4(418.52, -1646.36, 29.29, 52.73),
            vector4(420.62, -1641.93, 29.29, 96.54),
            vector4(420.59, -1638.92, 29.29, 93.19),
        }
    },
    ...
    ['impoundlot1'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(1413.4617919922, 3602.6381835938),
            vector2(1437.8228759766, 3611.654296875),
            vector2(1427.1815185547, 3637.8305664062),
            vector2(1404.2993164062, 3628.4418945312)
            },
            ['minZ'] = 34.856662750244,  -- min height of the parking zone
            ['maxZ'] = 35.074806213379,  -- max height of the parking zone
            debug = false,
        },
        label = "Impound Lot",
        showBlip = true,
        blipcoords = vector3(1418.65, 3621.21, 34.88),
        blipName = "Impound Lot",
        blipNumber = 68,
        type = 'depot',                --public, job, gang, depot
        vehicleCategories = {'car', 'motorcycle', 'other'},
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(1423.60, 3625.38, 34.85, 202.35),
            vector4(1420.21, 3623.95, 34.85, 204.42),
            vector4(1416.42, 3622.89, 34.86, 203.80),
            vector4(1411.98, 3621.76, 34.89, 199.50),
        }
    },
    ...
    ['impoundlot2'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(-176.83158874512, 6223.884765625),
            vector2(-193.54832458496, 6239.9765625),
            vector2(-217.66960144043, 6215.828125),
            vector2(-201.22407531738, 6199.6982421875)
            },
            ['minZ'] = 31.48423576355,  -- min height of the parking zone
            ['maxZ'] = 31.492723464966,  -- max height of the parking zone
            debug = false,
        },
        label = "Impound Lot",
        showBlip = true,
        blipcoords = vector3(-197.50, 6219.89, 31.49),
        blipName = "Impound Lot",
        blipNumber = 68,
        type = 'depot',                --public, job, gang, depot
        vehicleCategories = {'car', 'motorcycle', 'other'},
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(-197.58, 6228.61, 31.50, 232.70),
            vector4(-199.89, 6226.16, 31.50, 227.74),
            vector4(-202.44, 6223.99, 31.49, 230.96),
            vector4(-204.97, 6221.83, 31.49, 221.38),
            vector4(-207.42, 6219.69, 31.49, 223.32),
        }
    },
    ...
    ['apartments'] = {
        ...
        label = 'Gen-Z Appartment Parking',
        type = 'public',
        vehicleCategories = {'car', 'motorcycle', 'other'},
        showBlip = true,
        blipName = 'Gen-Z Appartment Parking',
        blipNumber = 357,
        blipColor = 49,
        blipcoords = vector3(-318.43, -982.31, 31.08),
        drawText = 'Parking',
        ["ParkingSpots"] = {
