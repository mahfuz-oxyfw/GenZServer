        ...
        if hasItem then
            ...
            QBCore.Functions.Progressbar('hack_gate', Lang:t('info.connecting_device'), math.random(5000, 10000), false, true, {
                ...
                if success then
                    ...
                    TriggerServerEvent('ox_doorlock:server:updateState', Gates[currentGate].gatekey, false, false, false, true)
                else
...
RegisterNetEvent('prison:client:PrisonBreakAlert', function()
    ...
    TriggerEvent('yseries:client:addPoliceAlert', alertData)
