<script lang="ts">
	...
	import { BROWSER_MODE, RESOURCE_NAME, RobberyVisible, PlayerVisible } from '@store/stores'
	...
	$RESOURCE_NAME = 'gz-scoreboard' // Change this to your resource name (case sensitive)
</script>

<VisibilityProvider>
	{#if $RobberyVisible || $PlayerVisible}
		<Container />
	{/if}
</VisibilityProvider>
