...
Config.ClothingCost = 320
Config.BarberCost = 320
Config.TattooCost = 320
...
Config.Stores = {
    ...
    {
        type = "clothing",
        coords = vector4(447.99, -994.55, 35.06, 2.88),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        showBlip = false,
        points = {
            vector3(448.54, -997.97, 35.06),
            vector3(445.96, -995.61, 35.59),
            vector3(445.96, -990.53, 35.53),
            vector3(452.13, -995.67, 35.06),
    ...
    {
        type = "clothing",
        coords = vector4(442.74, -994.72, 35.06, 355.22),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        showBlip = false,
        points = {
            vector3(463.90, -995.94, 30.69),
            vector3(458.73, -995.56, 30.69),
            vector3(457.04, -997.34, 30.69),
            vector3(457.66, -999.76, 30.69),
            vector3(463.90, -999.65, 30.94)
        }
    },

    {
        type = "clothing",
        coords = vector4(2748.68, 3494.43, 55.72, 244.50),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        showBlip = false,
        points = {
            vector3(2748.78, 3492.34, 55.72),
            vector3(2746.73, 3494.89, 55.72),
            vector3(2750.69, 3495.52, 55.72),
            vector3(2753.44, 3492.09, 55.72)
        }
    },

    {
        type = "clothing",
        coords = vector4(2750.98, 3499.40, 55.72, 243.03),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        showBlip = false,
        points = {
            vector3(2748.96, 3500.23, 55.72),
            vector3(2752.94, 3500.65, 55.72),
            vector3(2751.79, 3497.09, 55.72),
            vector3(2755.68, 3497.29, 55.72)
        }
    },
    --------------------------------------------------
    ...
    {
        type = "clothing",
        coords = vector4(-482.43, -990.27, 24.29, 224.02),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        showBlip = false,
        points = {
            vector3(-446.57, -1036.19, 33.69),
            vector3(-446.66, -1033.22, 33.69),
            vector3(-450.11, -1035.68, 33.69),
            vector3(-449.79, -1032.59, 33.69)
        }
    },
...
--    },
    {
        type = "surgeon",
        coords = vector4(-468.33, -1042.48, 33.69, 98.48),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(-465.97, -1043.73, 33.69),
            vector3(-465.92, -1040.85, 33.69),
            vector3(-470.77, -1040.79, 33.69),
            vector3(-471.32, -1043.96, 33.69)
        }
    }
}
...
Config.ClothingRooms = {
    -- {
    --     job = "police",
    --     coords = vector4(462.99, -998.91, 30.69, 85.94),
    --     size = vector3(4, 4, 4),
    --     rotation = 45,
    --     usePoly = false,
    --     points = {
    --         vector3(463.98, -999.72, 30.94),
    --         vector3(463.86, -997.58, 30.69),
    --         vector3(461.05, -999.66, 30.69),
    --         vector3(460.0, -998.13, 31.13)
    --     }
    -- },
    {
        job = "burgershot",
        coords = vector4(-1183.10, -900.66, 13.97, 37.55),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(-1184.90, -898.78, 13.97),
            vector3(-1181.86, -899.73, 13.97)
        }
    },
    -- {
    --     job = "ambulance",
    --     coords = vector4(-448.34, -1034.61, 33.69, 88.95),
    --     size = vector3(4, 4, 4),
    --     rotation = 45,
    --     usePoly = false,
    --     points = {
