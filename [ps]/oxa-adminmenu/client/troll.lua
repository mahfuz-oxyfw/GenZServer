-- Set on fire
RegisterNetEvent('oxa-adminmenu:client:SetOnFire', function(time)
...
-- Explode player
RegisterNetEvent('oxa-adminmenu:client:ExplodePlayer', function(damage)
...
-- Play Sound
RegisterNetEvent('oxa-adminmenu:client:PlaySound', function(data, selectedData)
...
-- Drunk Player
RegisterNetEvent('oxa-adminmenu:client:InitiateDrunkEffect', function()
