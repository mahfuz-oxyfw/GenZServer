...
Config.MaxInventoryWeight = 200000 -- Max weight a player can carry (default 250kg, written in grams)
...
Config.Progressbar = {
    ...
    minT = 150,             -- Min Time for Inventory to open
    maxT = 200              -- Max Time for Inventory to open
}
