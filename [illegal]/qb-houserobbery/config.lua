...
Config.Rewards = {
    { -- house tier
        ['cabin'] = {
            { item = 'romantic_book',           min = 1, max = 3 },
            { item = 'notepad',                 min = 1, max = 1 },
            { item = 'security_card_01',        min = 1, max = 1 },
            { item = 'security_card_02',        min = 1, max = 2 },
            { item = 'laptop',                  min = 1, max = 1 },
            { item = 'cryptostick',             min = 1, max = 1 },
            { item = 'trojan_usb',              min = 1, max = 2 },
        },
        ['kitchen'] = {
        ...
        ['chest'] = {
            { item = 'gold_watch',          min = 1, max = 4 },
            { item = 'gold_bracelet',       min = 1, max = 2 },
            { item = 'earings',             min = 1, max = 1 },
            { item = 'necklace',            min = 1, max = 1 },
        ...
        ['livingroom'] = {
            { item = 'security_card_01',      min = 1, max = 4 },
